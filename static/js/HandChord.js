...
export class HandChord {
    constructor() {
        ...
        this.nextCharsDisplay = new NextCharsDisplay({
            wholePhraseChords: document.getElementById(TerminalCssClasses.WholePhraseChords),
            chordImageHolder: document.getElementById(TerminalCssClasses.ChordImageHolder),
            svgCharacter: document.getElementById(TerminalCssClasses.SvgCharacter),
            testMode: document.getElementById(TerminalCssClasses.TestMode),
            setWpmCallback: () => { },
        });
